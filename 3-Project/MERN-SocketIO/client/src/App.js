        ...
        <div className="container">
                      ...
                      <Card key={i}>
                        ...
                        <div onClick={this.toggle}><div className="card-header">{room.toUpperCase()}</div></div>
                          <Collapse isOpen={this.state.collapse}>
                            <Card>
                              <h6 className="card-title">Enter Your Name to Join Room</h6>
                              <CardBody>
                              <input type="text" className="form-control" placeholder="Username" name="username" onChange={this.handleChange} />
                               <button className="btn btn-primary" onClick={() => this.joinRoom(room)}
                              >Join</button>
                              </CardBody>
                            </Card>
                          </Collapse>
          ...
          <div className="container"> 
            <div className="card">
              ...
              <div className="card-body">
                <div className="card-header"><h5 className="card-title">Create A Room</h5></div>
                  <div className="input-group mb-3">
                    <input type="text" className="form-control" placeholder="Enter a name for the room" name="room" onChange={this.handleChange} />
                  </div>

                  <div className="input-group mb-3">
                    <input type="text" className="form-control" placeholder="Enter your display name" name="username" onChange={this.handleChange} />
                  </div>
                  <button href="#" className="btn btn-primary" onClick={this.createRoom}>Join</button>
              </div>
            </div>
          </div>
        </div>
